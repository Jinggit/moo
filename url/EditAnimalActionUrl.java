...
public class EditAnimalActionUrl extends UrlAbstract {
    private String actionType;
    private String animalType;
    private String historyId;
    private String idAnimal;

    public EditAnimalActionUrl(String historyId, String actionType, String animalType, String idAnimal) {
        this.historyId = historyId;
        this.actionType = actionType;
        this.animalType = animalType;
        this.idAnimal = idAnimal;
        setStringUnsignedPart("/mobile-api/index/index/model/animal-edit/method/edit-animal-action/ts/");
    }
